...
namespace Hospital.Presentation.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPaginatedPatients([FromQuery] int pageNumber, [FromQuery] int pageSize)
        {
            ...
            _logger.LogInformation("Patients successfully extracted. Page items count: {Count}", paginatedPatients.Items.Count);
            ...
            [FromQuery] int pageSize, [FromBody] PatientFilterRequestDto patientFilter)
        {
            ...
            _logger.LogInformation("Patients with such properties were found. Page items count: {Count}", patients.Items.Count);
