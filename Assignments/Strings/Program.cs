namespace Strings
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Num of words: {text.Split(' ').Length}");

            //- Display the sentence count of this string
            char[] delimiters = ['.', '?', '!'];
            Console.WriteLine($"Num of sentences: {text.Split(delimiters).Length}");
            ...
            Console.WriteLine($"Num of occurences for encapsulation: {counter}");
            ...
            Console.WriteLine($"Substituted string: {text.Replace("object-oriented programming", "OOP")}");
        }
    }
}
